...
// const conString = 'postgres://USER:PASSWOt:5432RD@HOST:PORT/DBNAME';
const conString = 'postgres://postgres:1234@localhos';
...
app.get('/new', function(request, response) {
  ...
  //1.number 5 -response
  //2.there is no method in article.js
  //3.not using CRUD
